...
<br>
<div class="row" > <div class="col-md-12"> <div class="panel panel-primary"> <div class="panel-heading" > <div class="panel-title"  ><h3>Add  A New Template </h3></div> <div class="panel-options"> <a href="#" data-rel="collapse"><i class="entypo-down-open" id="bt" onclick="toggle(this)"></i></a> <a href="#" data-rel="close" class="bg"><i class="entypo-cancel"></i></a> </div> </div> 
...
<script>
 ...
 <!-- <button class="btn btn-primary btn-icon btn-block" type="button" id="formButton">Add Template <i class="entypo-plus"></i></button> -->
